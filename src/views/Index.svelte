    ...
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        <h2 class="font-semibold text-4xl text-blueGray-600">
          ...
          accusantium adipisci quos odio, perferendis quo dignissimos quas vitae
          voluptas magni, doloribus, minus eveniet at veritatis suscipit facere?
          Non, illo id?
        </h2>
        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime
          maiores quas aliquid, facilis vel quam earum delectus consectetur sit
          laboriosam. CSS from
          <a
        ...
        >
          ...
          <blockquote class="relative p-8 mb-4">
            ...
            <p class="text-md font-light mt-2 text-white">
              ...
              Explicabo aspernatur vel expedita laudantium sequi dolores, magni
              dolore cupiditate! Mollitia, perferendis. Lorem ipsum dolor sit,
              amet consectetur adipisicing elit. At nisi eveniet a nihil
              repellat commodi cum. Itaque dolores accusantium illum?
            </p>
          </blockquote>
        </div>
      </div>
            ...
            <div class="relative flex flex-col mt-4">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  ...
                  elit. Quibusdam minima iste asperiores blanditiis consectetur
                  assumenda reiciendis quasi repellendus cum perferendis?
                </p>
              </div>
            </div>
          ...
          <div class="w-full md:w-6/12 px-4">
            <div class="relative flex flex-col min-w-0 mt-4">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Ullam eius quisquam fugiat necessitatibus veniam aperiam hic
                  blanditiis at magnam est!
                </p>
              </div>
            </div>
            <div class="relative flex flex-col min-w-0">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  ...
                  error iste excepturi at voluptatibus laudantium amet repellat
                  nisi tenetur dicta?
                </p>
              </div>
            </div>
      ...
      <div class="w-full md:w-6/12 px-4 mr-auto ml-auto mt-32">
        <div class="justify-center flex flex-wrap relative">
          <div class="my-4 w-full lg:w-6/12 px-4">
            <a href="https://visionarylabs.io/" target="_blank">
  ...
  <div class="justify-center text-center flex flex-wrap mt-24">
    <div class="w-full md:w-6/12 px-12 md:px-4">
      ...
      <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
        ...
        eligendi fugit sed, distinctio reiciendis dolor inventore magni illo
        quisquam minus laudantium. Expedita, sit enim. Eveniet nostrum
        laudantium in molestiae?
      </p>
    </div>
  </div>
</section>
